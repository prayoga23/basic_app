...
floorDate:v,filterSeriesByType:F,hasValue:Z,lteDateIndex:V,evalOptions:O,seriesTotal:q,singleItemOrArray:S,sortDates:U,startOfWeek:x,transpose:j,toDate:f,toTime:g,uniqueDates:H})}(window.kendo.jQuery),window.kendo},"function"==typeof define&&define.amd?define:function(e,t,i){(i||t)()});
